# 1 "exercise_ifconfig.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 329 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "exercise_ifconfig.c" 2
...
# 198 "/usr/include/sys/unistd.h" 2 3 4
...
# 641 "/usr/include/unistd.h" 2 3 4
# 1 "/usr/include/sys/_types/_mode_t.h" 1 3 4
# 30 "/usr/include/sys/_types/_mode_t.h" 3 4
typedef __darwin_mode_t mode_t;
# 642 "/usr/include/unistd.h" 2 3 4
...
# 5 "exercise_ifconfig.c" 2

int main() {
    if (execl("/sbin/ifconfig", "/sbin/ifconfig", ((void *)0)) == -1)
        if (execlp("ipconfig", "ipconfig", ((void *)0)) == -1) {
            fprintf(__stderrp, "Cannot run ipconfig: %s", strerror((*__error())));
            return 1;
        }
    return 0;
}
